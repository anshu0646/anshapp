...
public class AnshappApp {

    private static final Logger log = LoggerFactory.getLogger(AnshappApp.class);

    private final Environment env;

    public AnshappApp(Environment env) {
        this.env = env;
    }
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(AnshappApp.class);
